...
android {
    namespace = "com.thejas.visionaireader"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.thejas.visionaireader"
        minSdk = 29
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // TFLite - document corner detection model
    implementation("org.tensorflow:tensorflow-lite:2.15.0")

    // Google Fonts (Instrument Serif + Geist) — runtime download via Play Services
